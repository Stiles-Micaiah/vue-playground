        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="border p-1">
                    ...
                    <input v-model="myName" placeholder="wizicle">
                    <button @click="submit" class="btn btn-sm btn-info rounded-pill">Enter</button>
                    <p> Result:{{ myName }}</p>
                </div>
                <div class="border p-1">
                    <h5>Class Binding</h5>
                    ...
                    <div class="red">
<button class="btn btn-success btn-md" @click="asActive = 0" ></button>                        <p>This text will turn green on active</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                message: "Super duper secret message here!",
